...
class MenuState extends FlxState
{
    ...
    override public function create():Void
    {
        ...
        _hostIpInput = new FlxInputText(centerX - 100/2, centerY + 30, 100, "127.0.0.1");
    ...
    {
        var localPort = Std.parseInt(_localPortInput.text);
        Server.getInstance().run(localPort);
        ...
        FlxG.switchState(new PlayState(_playerNameInput.text));
    }
}